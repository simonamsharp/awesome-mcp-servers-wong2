...
- **[WhichModel](https://github.com/Which-Model/whichmodel-mcp)** - Cost-optimized LLM model routing for AI agents — real-time pricing and benchmarks across 300+ models, updated every 4 hours.
